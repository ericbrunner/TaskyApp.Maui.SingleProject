namespace TaskyApp.Droid.Tasky
{
    ...
    {
        public const string TaskRunnerServiceRestart = "com.companyname.taskyapp.maui.GeoLocation.RestartTaskRunnerService";

        public const string TaskRunnerServiceBroadcastReceiver =
            "com.companyname.taskyapp.maui.GeoLocation.TaskRunnerServiceBroadcastReceiver";
